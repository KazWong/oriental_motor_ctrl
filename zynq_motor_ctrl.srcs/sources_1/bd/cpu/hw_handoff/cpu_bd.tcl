...
proc create_root_design { parentCell } {
  ...
  set dac_iic_bus [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:iic_rtl:1.0 dac_iic_bus ]
  ...
  set zynq_can [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:can_rtl:1.0 zynq_can ]
  set zynq_emio [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 zynq_emio ]

  # Create ports
  set exio_miso [ create_bd_port -dir I exio_miso ]
  set exio_mosi [ create_bd_port -dir O exio_mosi ]
  set exio_ncs [ create_bd_port -dir O exio_ncs ]
  set exio_sclk [ create_bd_port -dir O exio_sclk ]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_CAN_0 [get_bd_intf_ports zynq_can] [get_bd_intf_pins processing_system7_0/CAN_0]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_GPIO_0 [get_bd_intf_ports zynq_emio] [get_bd_intf_pins processing_system7_0/GPIO_0]
  connect_bd_intf_net -intf_net processing_system7_0_IIC_0 [get_bd_intf_ports dac_iic_bus] [get_bd_intf_pins processing_system7_0/IIC_0]
  ...
  connect_bd_net -net SPI0_MISO_I_0_1 [get_bd_ports exio_miso] [get_bd_pins processing_system7_0/SPI0_MISO_I]
  ...
  connect_bd_net -net processing_system7_0_SPI0_MOSI_O [get_bd_ports exio_mosi] [get_bd_pins processing_system7_0/SPI0_MOSI_O]
  connect_bd_net -net processing_system7_0_SPI0_SCLK_O [get_bd_ports exio_sclk] [get_bd_pins processing_system7_0/SPI0_SCLK_O]
  connect_bd_net -net processing_system7_0_SPI0_SS_O [get_bd_ports exio_ncs] [get_bd_pins processing_system7_0/SPI0_SS_O]
  connect_bd_net -net rst_ps7_0_50M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_50M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
