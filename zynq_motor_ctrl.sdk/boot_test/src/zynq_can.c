...
s32 SendFrame_NonBlk(XCanPs *InstancePtr, u32 txrx_id, u8* frame_data, u8 len){
	u32 TxFrame[4];
	u8 *FramePtr;
	int Index;
	s32 Status;
...
s32 RecvFrame_NonBlk(XCanPs *InstancePtr, u32 txrx_id, u32* RxFrame, u32 timeout){
	s32 Status;

	/*
	 * Exit if no frame is received.
	 */
