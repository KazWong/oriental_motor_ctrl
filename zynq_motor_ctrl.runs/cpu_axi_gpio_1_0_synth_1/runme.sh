...
HD_PWD='/home/whwong/Codes/xilinx/vivado/zynq_motor_basic_test.xpr/zynq_motor_ctrl/zynq_motor_ctrl.runs/cpu_axi_gpio_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_axi_gpio_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cpu_axi_gpio_1_0.tcl
